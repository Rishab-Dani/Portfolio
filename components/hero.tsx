          ...
          >
            <div className="space-y-4">
              ...
              <motion.p className="text-xl text-muted-foreground max-w-[600px]" {...staggerDelay(0.2)}>
                Enthusiastic and detail-oriented Java & Web Developer with hands-on experience in building responsive web applications and Java-based software solutions. Skilled in Java, Spring Boot, MySQL, Flutter and modern front-end technologies. Proven ability to work 
                collaboratively in team settings, deliver projects on time, and adapt quickly to new tools and frameworks.
              </motion.p>
            </div>
